 ...
 * @itsliaaa/baileys
 */
const { getRandomValues, randomUUID, randomBytes } = require('crypto');
const { BOT_RENDERING_CONFIG_METADATA, DONATE_URL, LEXER_REGEX } = require('../Defaults/index.js');
const { LANGUAGE_KEYWORDS } = require('../WABinary/constants.js');
const { CodeHighlightType, RichSubMessageType } = require('../Types/RichType.js');
const { proto } = require('../../WAProto');
const { unixTimestampSeconds } = require('./generics.js');
const textEncoder = new TextEncoder();
const NOOP = new Set([]);
exports.tokenizeCode = (code, language = 'javascript') => {
...
exports.buildAdditionalBotMetadataContext = (submessages) => {
    const sources = [];
...
exports.prepareRichResponseMessage = (content) => {
...
exports.botMetadataSignature = () => {
    const signature = new Uint8Array(64);
    getRandomValues(signature);
    return signature;
}
exports.botMetadataCertificate = (length = 700) => {
